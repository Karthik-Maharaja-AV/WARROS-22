        ...
        <div id='EVENTS' className='py-10 items-center jusitfy-center px-10'>
            <div>   
                ...
                <div className='flex lg:flex-row  flex-col items-center justify-center lg:grid lg:grid-cols-3 lg:py-5 mx-auto lg:pl-40'>
                    ...
                    {/* --------------------------------CINELOGY--------------------------------- */}
                    <div className='flex flex-col bg-white  lg:w-4/6 items-center justify-center my-10 px-3 py-2 rounded-xl'>
                        <div className='flex lg:h-44 h-36 w-36 lg:w-44 items-center justify-center'><img src="https://imgs.search.brave.com/tpYgyadIzmyTgD1wGI3Ki6hkucJsuqioHsOoQgZMdeA/rs:fit:980:872:1/g:ce/aHR0cDovL2Nkbi5v/bmxpbmV3ZWJmb250/cy5jb20vc3ZnL2lt/Z180OTc1NjIucG5n" alt="" /></div>
                        <div className='text-center p-5'>
                    ...
                    {/* --------------------------------TAXIC----------------------------------------------- */}
                    <div className='flex flex-col bg-white  lg:w-4/6 items-center justify-center my-10 px-3 py-2 rounded-xl'>
                        <div className='flex lg:h-44 h-36 w-36 lg:w-44 items-center justify-center'><img src="https://imgs.search.brave.com/RRxtAiWzHpZe8PwZS-yeyAbRuLMgQjw-tjVBkEV4SbY/rs:fit:512:512:1/g:ce/aHR0cHM6Ly9jZG40/Lmljb25maW5kZXIu/Y29tL2RhdGEvaWNv/bnMvZGVtb2NyYWN5/LzUwMC9Qb2xpdGlj/YWxfMTMtNTEyLnBu/Zw" alt="" /></div>
                        <div className='text-center p-5'>
