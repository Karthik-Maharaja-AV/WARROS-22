...
const Navbar = () => {
    ...
    const open = ul + " absolute flex flex-col bg-black  w-screen bg-transparent h-max top-0 p-10 hover:border-4 left-0 gap-6 text-center mt-16 ";
    const closed = ul + " hidden";
    return (
        <div>
            <nav className='relative xl:h-18 z-50 flex w-full bg-transparent  border-0 border-b-4 border-b-white px-6 lg:px-20 py-10 justify-between'>
